...
In this section, the state diagrams associated with some classes from the previously presented class diagram are shown.
We thought to model the diagrams associated with the Internship and InternshipStatus classes to better clarify their lifecycle within the system.
