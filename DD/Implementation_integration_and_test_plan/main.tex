...
The first components to be developed and tested will be the Data Manager, the Recommendation Manager and the Email Manager.
}{0.3}

\compDevel{Login and Registration}{
The next components to be integrated will be the Registration Manager and the Login Manager. 
...
Finally, the last component will be integrated: the controller.

\begin{figure}[H]
    \centering
    \includegraphics[scale=0.2]{Implementation_integration_and_test_plan/uml_diagrams/feat8.png}
    \caption{Developement of the \textit{Controller}.}
\end{figure}
