...
\begin{itemize}
      ...
      Thus, after that, students will be able to view the new proposal submitted by the company (by searching through keywords or thanks the recommendation system).
...
\begin{itemize}
    ...
    \item \text{[DA14]} University member who registers his university into the system inserts correct information.
    \item \text{[DA15]} Company member who registers his company into the system inserts correct information.
\end{itemize}
